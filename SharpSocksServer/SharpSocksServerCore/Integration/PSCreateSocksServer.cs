...
namespace SharpSocksServer.Source.Integration
{
    ...
    {
        public static SharpSocksServerController CreateSocksController(String ipToListen, String serverUri, X509Certificate2 serverCert, String commandChannelId, ushort SocksPort, String EncryptionKey, String SessionCookieName, String PayloadCookieName, ILogOutput logComms, UInt32 SocketTimeout = 1200000)
        {
            var logOutput = logComms ?? new DebugConsoleOutput();
            var mstr = new SharpSocksServerController() { ServerComms = logComms, WaitOnConnect = true, SocketTimeout  = SocketTimeout };
